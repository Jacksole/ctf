# Madness Box on TryHackMe.com

## IP Address is 10.10.200.109

## Nmap Scan
```
Starting Nmap 7.91 ( https://nmap.org ) at 2021-01-08 06:06 Eastern Standard Time
...
TCP/IP fingerprint:
OS:SCAN(V=7.91%E=4%D=1/8%OT=22%CT=1%CU=31646%PV=Y%DS=4%DC=I%G=Y%TM=5FF83CC9
OS:%P=i686-pc-windows-windows)SEQ(SP=105%GCD=1%ISR=105%TI=Z%CI=I%II=I%TS=8)
OS:SEQ(CI=I%II=I)OPS(O1=M506ST11NW6%O2=M506ST11NW6%O3=M506NNT11NW6%O4=M506S
OS:T11NW6%O5=M506ST11NW6%O6=M506ST11)WIN(W1=68DF%W2=68DF%W3=68DF%W4=68DF%W5
OS:=68DF%W6=68DF)ECN(R=Y%DF=Y%T=40%W=6903%O=M506NNSNW6%CC=Y%Q=)T1(R=Y%DF=Y%
...
```
## Source Code from IP at port 80
...
Look at blank icon  and wget it to terminal and hexedit to correct file type to find the hidden directory

Find secret number by bruteforce
